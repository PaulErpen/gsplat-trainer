from gsplat_trainer.geometry.geometry_utils import normalized_quat_to_rotmat
from gsplat_trainer.train.strategy.wrappers.quat_scale_to_covar_preci_wrapper import (
    quat_scale_to_covar_preci,
)
from gsplat_trainer.train.strategy.wrappers.compute_relocation_wrapper import (
    compute_relocation,
)
import numpy as np
...
def inject_noise_to_position(
    ...
    def op_sigmoid(x, k=100, x0=0.995) -> Tensor:
